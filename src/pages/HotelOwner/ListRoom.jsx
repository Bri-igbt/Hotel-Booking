    ...
    return (
        <div>
            <Title 
                ...
                font='outfit' 
                title='Room Listings' 
                subTitle='View, edit or manage all listed room. Keep the information up-to-date to provide the best information to users'
            />
                                ...
                                <tr key={index}>
                                    ...
                                    <td className='py-3 px-4 text-red-500 text-center border-t border-gray-300'>
                                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                                            ...
                                            <span className='dot absolute left-1 top-1 w-5 h-5 bg-white rounded-full transition-transformn duration-200 ease-in-out peer-checked:translate-x-5'></span>
                                        </label>
                                    </td>
                                </tr>
                            ))
