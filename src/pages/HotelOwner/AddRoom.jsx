...
const AddRoom = () => {
    ...
    return (
        <form>
            ...
            <p className='text-gray-800 pt-10'>Images</p>
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                <div className='flex-1 max-w-48'>
                    ...
                    <select 
                        ...
                        className='border opacity-70 mt-1 border-gray-300 rounded p-2 w-full'
                    >
                ...
                <div>
                    ...
                    <input 
                        type="number" 
                        placeholder='0' 
                        className='mt-1 border border-gray-300 p-2 w-24 rounded' value={inputs.pricePerNight} 
            ...
            <button className='bg-primary px-8 py-2 text-white mt-8 rounded cursor-pointer'>
                Add Room
            </button>
        </form>
    )
